...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.shit.loshan.co.uk", true);
        vSeeds.emplace_back("dnsseed.thrasher.io", true);
        vSeeds.emplace_back("dnsseed.shittools.com", true);
        vSeeds.emplace_back("dnsseed.shitpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.shittools.com", true);
        vSeeds.emplace_back("seed-b.shit.loshan.co.uk", true);
