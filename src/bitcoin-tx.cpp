...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s shit-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  shit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded shit transaction") + "\n" +
              "  shit-tx [options] -create [commands]   " + _("Create hex-encoded shit transaction") + "\n" +
              "\n";
