...
const char * const BITCOIN_CONF_FILENAME = "shit.conf";
const char * const BITCOIN_PID_FILENAME = "shit.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Shit";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Shit";
#else
    // Unix
    return pathRet / ".shit";
#endif
