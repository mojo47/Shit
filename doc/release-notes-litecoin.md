Shit Core version *0.15.1* is now available from:

  <https://download.shit.org/shit-0.15.1/>
...
A number of changes to the way Shit Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 poo per kB (0.00001 SHT). This is to prepare for dropping the minimum transaction fee to 0.1 poo per kB (0.0001 SHT) in the next release.
